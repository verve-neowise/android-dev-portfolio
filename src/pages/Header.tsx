...
function Header() {
  ...
  return (
    <header className="fixed top-0 inset-x-0 bg-black/50 backdrop-blur-sm">
      <div className="container mx-auto px-4 md:px-0 py-5 flex justify-between items-center">
        ...
        <div
          className={classNames(
              "fixed md:relative h-screen md:h-auto p-4 md:p-0 text-lg md:text-base top-0 right-0 w-full max-w-xs md:w-auto md:max-w-none bg-black md:bg-transparent transition-all",
              {
